...
public class BusinessCode {
    ...
    public static final String VALIDATION_FILM_REALISATEUR = "validation.film.realisateur.null";
    public static final String VALIDATION_FILM_TITRE_MAX = "validation.film.titre.length";
    public static final String VALIDATION_FILM_ANNEE = "validation.film.annee";
    public static final String VALIDATION_FILM_DUREE_MIN = "validation.film.duree";
    public static final String VALIDATION_FILM_SYNOPSIS_SIZE = "validation.film.synopsis.length";
    public static final String VALIDATION_FILM_SYNOPSIS = "validation.film.synopsis.blank";
    public static final String VALIDATION_FILM_IDGENRE = "validation.film.genre.id.inconnu";
    public static final String VALIDATION_FILM_IDREALISATEUR = "validation.film.realisateur.id.inconnu";
    ...
    public static final String BLL_PARTICIPANT_ID_INCONNU="validation.film.participant.id.inconnu";
